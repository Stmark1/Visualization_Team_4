# visualization_challenge guide installation
...
activate visualization_challenge
```
...
To move beyond notebook prototyping, all reusable code should go into the `visualization_challenge/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `visualization_challenge` folder and use the modules inside your notebooks :
...
```python
from visualization_challenge.utils.paths import data_dir
data_dir()
```
